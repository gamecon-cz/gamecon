...
<div style="font-size: 13pt; font-weight: bold; text-align: center;  margin-top: 12px; margin-bottom: 12px;"> Program je již kompletní. Další aktivity mohou přibývat již jen po jednotkách.</div> Pokud nechcete, aby vám cokoliv uniklo, zanechte nám níže svůj mail a rádi se připomeneme s (pouze) důležitými aktualitami. Doporučujeme také sledovat náš profil na <a href="https://www.facebook.com/gamecon" onclick="return!window.open(this.href)" title="Facebook">Facebooku</a>.<br><br>
