...
} elseif (/* TODO revert */false && !in_array($u->id(), $aktivita->getOrganizatoriIds(), false)) {
    $problem = true;
    $sablonaKProblemu->assign('aktivita', $aktivita);
...
if ($problem) {
    $urlZpet = parse_url($_SERVER['REQUEST_URI'], PHP_URL_PATH) . '/..';
    $sablonaKProblemu->assign('urlNaMojeAktivity', $urlZpet);
