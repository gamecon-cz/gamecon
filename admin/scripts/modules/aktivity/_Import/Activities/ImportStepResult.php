...
class ImportStepResult
{
     ...
     * @var string[]
     */
    private array $errorLikeWarnings;
    /**
     * @var string
     */
    ...
    public static function success(mixed $success): ImportStepResult
    {
    ...
    public static function successWithWarnings(
        mixed $success,
        array $warnings,
        array $errorLikeWarnings = [],
    ): ImportStepResult {
        return new static($success, $warnings, $errorLikeWarnings, '');
    }

    public static function successWithErrorLikeWarnings(
        mixed $success,
        array $errorLikeWarnings,
    ): ImportStepResult {
