...
if (!empty($_SESSION["id_uzivatele"])){
  $sql="
    ...
    echo "
      <strong>Aktivní uživatel</strong> » login (jméno a příjmení): <strong>".mysql_result($result,0,0)." (".mysql_result($result,0,1)." ".mysql_result($result,0,2).")</strong> <a href=\"javascript: document.getElementById('zrusit').submit()\">zrušit práci s uživatelem</a>";
    ?>
