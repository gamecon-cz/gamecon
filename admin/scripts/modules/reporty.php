...
if (ma_pravo($_SESSION["id_admin"],110)){

  echo "Mínusoví účastníci 2011<br />";

}

if (ma_pravo($_SESSION["id_admin"],109)){

  echo "BIG FUCKING GANDALF(report) 2011<br />";
...
if (ma_pravo($_SESSION["id_admin"],109)){
  ...
  echo "Ubytovací report<br />";

}

if (ma_pravo($_SESSION["id_admin"],109)){

  echo "Report účastníků s chybou v ubytování<br />";

}

if (ma_pravo($_SESSION["id_admin"],110)){

  echo "Report odhadu financí (dlouho se generuje!!!)<br />";

}

if (ma_pravo($_SESSION["id_admin"],110)){

  echo "Report účastníků s minusovým účtem<br />";

}

if (ma_pravo($_SESSION["id_admin"],110)){

  echo "Report účastníků s plus účtem (+ adminu a minusovych zucastnenych)<br />";

}

if (ma_pravo($_SESSION["id_admin"],110)){

  echo "BFG (Big Fucking Gandalfreport)<br />";
...
if (ma_pravo($_SESSION["id_admin"],110)){
  ...
  echo "Mínusoví účastníci 2010<br />";
...
if (ma_pravo($_SESSION["id_admin"],109)){
  ...
  echo "BIG FUCKING GANDALF(report) 2010<br />";
