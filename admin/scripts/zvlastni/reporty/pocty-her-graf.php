...
<style>
.graf { background-color: #eee; padding: 10px; font-family: Arial; }
.graf > div { display: inline-block; margin: 3px; font: 10px Arial; line-height: 20px; text-align: center; max-width: 20px; }
.graf > div > div { width: 20px; background-color: #74BAFF; }
</style>
