...
WHERE uzivatele_hodnoty.id_uzivatele = platne_role_uzivatelu.id_uzivatele AND platne_role_uzivatelu.id_role = $2) AS prihlasen_na_gc
...
ORDER BY prihlasen_na_gc DESC,
         ...
         registrovan DESC;
SQL
  , [1 => GC_BEZI_OD, 2 => \Gamecon\Role\Role::PRIHLASEN_NA_LETOSNI_GC]
);
