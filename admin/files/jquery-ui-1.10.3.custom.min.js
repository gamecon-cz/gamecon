...
(function (t, e) {
  ...
  t.cleanData = function (e) {
    ...
    i = i.split(".")[1], n = c + "-" + i, o || (o = s, s = t.Widget), t.expr.pseudos[n.toLowerCase()] = function (e) {
      return !!t.data(e, n)
    ...
    }), a.prototype = t.widget.extend(l, {widgetEventPrefix: r ? l.widgetEventPrefix : i}, h, {
      constructor: a,
      namespace: c,
      widgetName: i,
      widgetFullName: n
...
(function (t, e) {
  ...
  t.position = {
    ...
    e = t.extend({}, e);
    var a, p, g, m, v, _, b = t(e.of), y = t.position.getWithinInfo(e.within), w = t.position.getScrollInfo(y),
      k = (e.collision || "flip").split(" "), D = {};
    return _ = n(b), b[0].preventDefault && (e.at = "left top"), p = _.width, g = _.height, m = _.offset, v = t.extend({}, m), t.each(["my", "at"], function () {
      ...
      var n, h, c = t(this), u = c.outerWidth(), d = c.outerHeight(), f = s(this, "marginLeft"),
        _ = s(this, "marginTop"), x = u + f + s(this, "marginRight") + w.width,
        C = d + _ + s(this, "marginBottom") + w.height, M = t.extend({}, v),
      ...
      "right" === e.my[0] ? M.left -= u : "center" === e.my[0] && (M.left -= u / 2), "bottom" === e.my[1] ? M.top -= d : "center" === e.my[1] && (M.top -= d / 2), M.left += T[0], M.top += T[1], t.support.offsetFractions || (M.left = l(M.left), M.top = l(M.top)), n = {
        ...
        t.ui.position[k[i]] && t.ui.position[k[i]][s](M, {
          targetWidth: p,
          targetHeight: g,
          elemWidth: u,
          elemHeight: d,
