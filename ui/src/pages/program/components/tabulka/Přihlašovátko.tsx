...
export const Přihlašovátko: FunctionComponent<TPřihlašovátkoProps> = (
  ...
  // odsazení (oddělovač od textu „pouze … místa") se vloží jen když nějaké tlačítko vznikne
  function sledováníTlačítko(oddělovač = "") {
    ...
    return <>{oddělovač}<FormTlačítko akitivitaId={akitivitaId} typ={typ} tymova={aktivita?.tymova} /></>;
  }
};
