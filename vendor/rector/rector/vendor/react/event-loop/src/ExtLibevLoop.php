...
use RectorPrefix202603\libev\EventLoop;
use RectorPrefix202603\libev\IOEvent;
use RectorPrefix202603\libev\SignalEvent;
use RectorPrefix202603\libev\TimerEvent;
...
final class ExtLibevLoop implements LoopInterface
{
    ...
    {
        if (!\class_exists('RectorPrefix202603\libev\EventLoop', \false)) {
