...
final class ExtUvLoop implements LoopInterface
{
    ...
    {
        if (!\function_exists('uv_loop_new') && !\function_exists('RectorPrefix202603\uv_loop_new')) {
    ...
    {
        if (!isset($this->streamEvents[(int) $stream])) {
            $this->streamEvents[(int) $stream] = \RectorPrefix202603\uv_poll_init_socket($this->uv, $stream);
        }
