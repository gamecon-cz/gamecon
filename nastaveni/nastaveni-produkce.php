...
// Archive 2019 production settings — committed to archive/2019.
//
...
// Archive 2019: single subdomain serves the whole year, with /admin and
// /cache/public as path aliases of the one Apache DocumentRoot. The
// admin.2019 / cache.2019 sub-subdomains are no longer published in DNS.
define('URL_WEBU', 'https://2019.gamecon.cz');               // absolutní url uživatelského webu
define('URL_ADMIN', 'https://2019.gamecon.cz/admin');        // absolutní url adminu (path-based)
define('URL_CACHE', 'https://2019.gamecon.cz/cache/public'); // url sdílených cachí (path-based)
...
// the same as DB_USER. (2019-era code references DBM_* in some paths.)
