...
// Archive 2020 production settings — committed to archive/2020.
//
...
// Archive 2020: single subdomain serves the whole year, with /admin and
// /cache/public as path aliases of the one Apache DocumentRoot. The
// admin.2020 / cache.2020 sub-subdomains are no longer published in DNS.
define('URL_WEBU', 'https://2020.gamecon.cz');               // absolutní url uživatelského webu
define('URL_ADMIN', 'https://2020.gamecon.cz/admin');        // absolutní url adminu (path-based)
define('URL_CACHE', 'https://2020.gamecon.cz/cache/public'); // url sdílených cachí (path-based)
...
// the same as DB_USER. (2020-era code references DBM_* in some paths.)
