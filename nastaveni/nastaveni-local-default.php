...
if (!defined('DBM_PASS')) define('DBM_PASS', getenv('DBM_PASS') ?: DB_PASS);

if (!defined('DB_ANONYM_SERV')) define('DB_ANONYM_SERV', getenv('DB_ANONYM_SERV') ?: DB_SERV);
if (!defined('DB_ANONYM_USER')) define('DB_ANONYM_USER', getenv('DB_ANONYM_USER') ?: DBM_USER);
if (!defined('DB_ANONYM_PASS')) define('DB_ANONYM_PASS', getenv('DB_ANONYM_PASS') ?: DBM_PASS);
//if (!defined('DB_ANONYM_PORT')) define('DB_ANONYM_PORT', DB_PORT);
if (!defined('DB_ANONYM_NAME')) define('DB_ANONYM_NAME', getenv('DB_ANONYM_NAME') ?: 'anonymni_databaze');

$baseUrl = (($_SERVER['HTTPS'] ?? 'off') === 'on' ? 'https' : 'http') . '://' . ($_SERVER['HTTP_HOST'] ?? 'localhost');
if (!defined('URL_WEBU')) getenv('URL_WEBU') ?: define('URL_WEBU', $baseUrl . '/web'); // absolutní url uživatelského webu
if (!defined('URL_ADMIN')) getenv('URL_ADMIN') ?: define('URL_ADMIN', $baseUrl . '/admin'); // absolutní url adminu
if (!defined('URL_CACHE')) getenv('URL_CACHE') ?: define('URL_CACHE', $baseUrl . '/cache/public'); // url sdílených cachí
...
if (!defined('UNIVERZALNI_HESLO')) define('UNIVERZALNI_HESLO', getenv('UNIVERZALNI_HESLO') ?: ''); // obejití zadávání hesla pro vývojové prostředí
