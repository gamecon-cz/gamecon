...
// Archive 2025: single subdomain serves the whole year, with /admin and
...
define('URL_WEBU', 'https://2025.gamecon.cz');               // absolutní url uživatelského webu
define('URL_ADMIN', 'https://2025.gamecon.cz/admin');        // absolutní url adminu (path-based)
define('URL_CACHE', 'https://2025.gamecon.cz/cache/public'); // url sdílených cachí (path-based, mirrors verejne-nastaveni-preview.php)
