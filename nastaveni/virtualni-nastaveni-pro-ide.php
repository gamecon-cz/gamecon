...
const BONUS_ZA_STANDARDNI_3H_AZ_5H_AKTIVITU = 0;

const AKTIVITA_EDITOVATELNA_X_MINUT_PRED_JEJIM_ZACATKEM = 0;
const AKTIVITA_EDITOVATELNA_X_MINUT_PO_JEJIM_UZAVRENI = 0;
const PRIHLASENI_NA_POSLEDNI_CHVILI_X_MINUT_PRED_ZACATKEM_AKTIVITY = 0;

const NEPLATIC_CASTKA_VELKY_DLUH = 0.0;
const NEPLATIC_CASTKA_POSLAL_DOST = 0.0;
const NEPLATIC_POCET_DNU_PRED_VLNOU_KDY_JE_CHRANEN = 0;
