...
const KOLIK_MINUT_JE_ODHLASENI_AKTIVITY_BEZ_POKUTY             = 0;
const KOLIK_HODIN_PRED_ZACATKEM_AKTIVITY_JE_UZ_STORNO_POPLATEK = 0; // kolik hodin před aktivitou se začne uplatňovat pokuta

const PRISTI_VLNA_KDY        = null;
