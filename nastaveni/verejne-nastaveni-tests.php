...
define('DB_SERV', 'sql.gamecon.tests');
define('DB_TEST_PREFIX', 'gamecon_test_');
if (!defined('DB_NAME')) {
    define('DB_NAME', $_COOKIE['gamecon_test_db'] ?? DB_TEST_PREFIX . '1');
}
if (!defined('DB_ANONYM_NAME')) {
    define('DB_ANONYM_NAME', $_COOKIE['gamecon_test_anonym_db'] ?? (DB_TEST_PREFIX . 'anonym_1'));
}
