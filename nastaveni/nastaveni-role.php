...
if (!defined('ROLE_PREPINANI_UZIVATELE')) define('ROLE_PREPINANI_UZIVATELE', Role::LETOSNI_PREPINANI_UZIVATELE());
if (!defined('ROLE_JEDNA_AKTIVITA_ZDARMA')) define('ROLE_JEDNA_AKTIVITA_ZDARMA', Role::LETOSNI_JEDNA_AKTIVITA_ZDARMA());
