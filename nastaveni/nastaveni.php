...
@define('ROK',                    2020);                    // aktuální rok -- při změně roku viz http://bit.ly/2l5olnb
@define('GC_BEZI_OD',             ROK.'-07-16 07:00:00');   // začátek GameConu (přepnutí stránek do režimu "úpravy na jen na infopultu")
@define('GC_BEZI_DO',             ROK.'-07-19 21:00:00');   // konec GameCou (přepnutí stránek do režimu "gc skončil, úpravy nemožné")
...
$GLOBALS['HLASKY']=[
  ...
  'prihlaseniVypnuto'=>'Přihlašování na GameCon ještě není spuštěno.',
