...
if(!$zaplaceno) {
    ...
    $qr_kod='http://api.paylibo.com/paylibo/generator/czech/image?accountNumber=222885&bankCode=5500&amount='.$castka.'.00&currency=CZK&vs='.$uid.'&message=Platba%20za%20GameCon';
    if($u->stat()=='CZ') {
        $castka.='&thinsp;Kč';
    } else {
