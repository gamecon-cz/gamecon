...
#[ORM\Index(name: 'rok', columns: ['rok'])]
#[ORM\Index(name: 'patri_pod', columns: ['patri_pod'])]
#[ORM\Index(name: 'lokace', columns: ['lokace'])]
#[ORM\Index(name: 'typ', columns: ['typ'])]
#[ORM\Index(name: 'stav', columns: ['stav'])]
#[ORM\Index(name: 'popis', columns: ['popis'])]
#[ORM\Index(name: 'FK_akce_seznam_zamcel_to_uzivatele_hodnoty', columns: ['zamcel'])]
