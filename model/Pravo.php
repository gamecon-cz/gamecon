...
class Pravo extends \DbObject
{
    ...
    public const ZMENA_HISTORIE_AKTIVIT = P_ZMENA_HISTORIE; // může přihlašovat a odhlašovat lidi z aktivit, které už proběhly
    ...
    public const ZOBRAZOVAT_VE_STATISTIKAK_V_TABULCE_UCASTI = 1024; // V adminu v sekci statistiky v tabulce vlevo nahoře se tato židle vypisuje
