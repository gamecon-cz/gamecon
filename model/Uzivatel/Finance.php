...
class Finance
{
    ...
    private $cenaAktivity = 0.0;  // cena aktivit
    private $cenaUbytovani = 0.0;  // cena objednaného ubytování
    private $cenaPredmety = 0.0;  // cena předmětů a dalších objednávek v shopu
