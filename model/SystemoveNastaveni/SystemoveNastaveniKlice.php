...
class SystemoveNastaveniKlice
{
    ...
    public const MIKINY_LZE_OBJEDNAT_A_MENIT_DO_DNE                           = 'MIKINY_LZE_OBJEDNAT_A_MENIT_DO_DNE';
    ...
    public const SLEVA_KOSTEK_ZDARMA_POCET            = 'SLEVA_KOSTEK_ZDARMA_POCET';
    public const SLEVA_PLACEK_ZDARMA_POCET            = 'SLEVA_PLACEK_ZDARMA_POCET';
    public const SLEVA_TRICEK_ZDARMA_POCET            = 'SLEVA_TRICEK_ZDARMA_POCET';
    public const SLEVA_DVOU_TRICEK_ZDARMA_POCET       = 'SLEVA_DVOU_TRICEK_ZDARMA_POCET';
    public const SLEVA_BONUSOVYCH_TRICEK_ZDARMA_POCET = 'SLEVA_BONUSOVYCH_TRICEK_ZDARMA_POCET';
