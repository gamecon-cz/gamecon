...
class Finance
{
     ...
     */
    public function posledniPlatba() {
     ...
     */
    public function pripis($castka, Uzivatel $provedl, $poznamka = null) {
        dbQuery(
    ...
    ', [$this->u->id(), ROK]);
        ...
        foreach ($o as $r) {
            ...
            // započtení ceny
            if ($r['typ'] == Shop::TYP_UBYTOVANI) {
                $this->cenaUbytovani += $cena;
            } elseif ($r['typ'] == Shop::TYP_VSTUPNE) {
            ...
            } elseif ($r['typ'] == Shop::TYP_PROPLACENI_BONUSU) {
