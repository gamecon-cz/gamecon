...
SELECT 333, id_predmetu, $0, (id_predmetu / 100) AS cena_nakupni FROM shop_predmety WHERE id_predmetu BETWEEN 33311 AND 33316
SQL,
            [0 => SystemoveNastaveni::ROK],
        ],
    ];
    ...
    public function Cena_nakupu_odpovida() {
        ...
        self::assertSame(
            round(333.11 + 333.12 + 333.15 + 333.16, 2),
