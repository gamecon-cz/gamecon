...
--
-- Host: 127.0.0.1    Database: gamecon_test_647d8731db8713.74779045
-- ------------------------------------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=203 DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `systemove_nastaveni` (
  ...
  `rocnik_nastaveni` int(11) NOT NULL,
...
INSERT INTO `systemove_nastaveni` VALUES (18,'AKTIVITA_EDITOVATELNA_X_MINUT_PRED_JEJIM_ZACATKEM','20',1,'integer','Kolik minut před začátkem lze už aktivitu editovat','Kolik minut před začátkem aktivity už může vypravěč editovat přihlášené','2023-06-05 06:53:12','Aktivita',NULL,0,-1),(21,'AUTOMATICKY_UZAMKNOUT_AKTIVITU_X_MINUT_PO_ZACATKU','45',1,'integer','Po kolika minutách se aktivita sama zamkne','Po jaké době běžící aktivitu uzamkne automat, pokud to někdo neudělá ručně - může to být se zpožděním, automat se pouští jen jednou za hodinu','2023-06-05 06:53:12','Aktivita',NULL,0,-1),(4,'BONUS_ZA_STANDARDNI_3H_AZ_5H_AKTIVITU','280',1,'integer','Bonus za vedení 3-5h aktivity','Kolik dostane vypravěč standardní aktivity, která trvala tři až pět hodin','2023-06-05 06:53:12','Finance',4,0,-1),(33,'DRUHA_VLNA_KDY','',0,'datetime','Začátek druhé vlny aktivit','Kdy se podruhé hromadně změní aktivity Připravené k aktivaci na Aktivované','2023-06-05 06:53:12','Časy',21,0,-1),(10,'GC_BEZI_DO','',0,'datetime','Konec Gameconu','Datum a čas, kdy končí Gamecon','2023-06-05 06:53:12','Časy',6,0,-1),(9,'GC_BEZI_OD','',0,'datetime','Začátek Gameconu','Datum a čas, kdy začíná Gamecon','2023-06-05 06:53:12','Časy',5,0,-1),(42,'HROMADNE_ODHLASOVANI_1','',0,'datetime','První hromadné odhlašování','Kdy budou poprvé hromadně odhlášeni neplatiči','2023-06-05 06:53:12','Časy',23,0,0),(43,'HROMADNE_ODHLASOVANI_2','',0,'datetime','Druhé hromadné odhlašování','Kdy budou podruhé hromadně odhlášeni neplatiči','2023-06-05 06:53:12','Časy',24,0,0),(44,'HROMADNE_ODHLASOVANI_3','',0,'datetime','Třetí hromadné odhlašování','Kdy budou potřetí hromadně odhlášeni neplatiči','2023-06-05 06:53:12','Časy',25,0,0),(26,'JIDLO_LZE_OBJEDNAT_A_MENIT_DO_DNE','',0,'date','Ukončení prodeje jídla na konci dne','Datum, do kdy ještě (včetně) lze v přihlášce měnit jídlo, než se zamkne','2023-06-05 06:53:12','Časy',14,0,-1),(1,'KURZ_EURO','24',1,'number','Kurz Eura','Kolik kč je pro nás letos jedno €','2023-06-05 06:53:12','Finance',1,0,-1),(16,'NEPLATIC_CASTKA_POSLAL_DOST','1000',1,'number','Už dost velká částka proti odhlášení','Kolik kč musí letos účastník poslat, abychom ho nezařadili do neplatičů','2023-06-05 06:53:12','Neplatič',NULL,0,-1),(15,'NEPLATIC_CASTKA_VELKY_DLUH','200',1,'number','Ještě příliš velký dluh neplatiče','Kolik kč je pro nás stále tak velký dluh, že mu hrozí odhlášení jako neplatiči','2023-06-05 06:53:12','Neplatič',NULL,0,-1),(17,'NEPLATIC_POCET_DNU_PRED_VLNOU_KDY_JE_CHRANEN','7',1,'integer','Počet dní od registrace před hromadným odhlašováním kdy je chráněn','Kolik nejvýše dní od registrace do odhlašovací vlny neplatičů je nový účastník ještě chráněn, aby nebyl brán jako neplatič','2023-06-05 06:53:12','Neplatič',NULL,0,-1),(45,'POSILAT_MAIL_O_ODHLASENI_A_UVOLNENEM_UBYTOVANI','0',1,'boolean','Poslat nám e-mail o uvolněném ubytování','Když se účastník odhlásí z GC a měl objednané ubytování, tak nám o tom přijde email na info@gamecon.cz','2023-06-05 06:53:13','Notifikace',26,0,-1),(27,'PREDMETY_BEZ_TRICEK_LZE_OBJEDNAT_A_MENIT_DO_DNE','',0,'date','Ukončení prodeje předmětů (vyjma oblečení) na konci dne','Datum, do kdy ještě (včetně) lze v přihlášce měnit předměty, než se zamknou','2023-06-05 06:53:12','Časy',15,0,-1),(20,'PRIHLASENI_NA_POSLEDNI_CHVILI_X_MINUT_PRED_ZACATKEM_AKTIVITY','10',1,'integer','Kolik minut před začátkem aktivity je \"na poslední chvíli\"','Nejvíce před kolika minutami před začátkem aktivity se účastník přihlásí, aby Moje aktivity ukázaly varování, že je nejspíš na cestě a ať na něj počkají','2023-06-05 06:53:12','Aktivita',NULL,0,-1),(35,'PRUMERNE_LONSKE_VSTUPNE','0.0',1,'number','Průměrné loňské vstupné','Abychom mohli zobrazit kostku na posuvníku dobrovolného vstupného','2023-06-05 06:53:12','Finance',22,1,2016),(36,'PRUMERNE_LONSKE_VSTUPNE','0.0',1,'number','Průměrné loňské vstupné','Abychom mohli zobrazit kostku na posuvníku dobrovolného vstupného','2023-06-05 06:53:12','Finance',22,1,2017),(37,'PRUMERNE_LONSKE_VSTUPNE','0.0',1,'number','Průměrné loňské vstupné','Abychom mohli zobrazit kostku na posuvníku dobrovolného vstupného','2023-06-05 06:53:12','Finance',22,1,2018),(38,'PRUMERNE_LONSKE_VSTUPNE','0.0',1,'number','Průměrné loňské vstupné','Abychom mohli zobrazit kostku na posuvníku dobrovolného vstupného','2023-06-05 06:53:12','Finance',22,1,2019),(39,'PRUMERNE_LONSKE_VSTUPNE','0.0',1,'number','Průměrné loňské vstupné','Abychom mohli zobrazit kostku na posuvníku dobrovolného vstupného','2023-06-05 06:53:12','Finance',22,1,2020),(40,'PRUMERNE_LONSKE_VSTUPNE','0.0',1,'number','Průměrné loňské vstupné','Abychom mohli zobrazit kostku na posuvníku dobrovolného vstupného','2023-06-05 06:53:12','Finance',22,1,2021),(41,'PRUMERNE_LONSKE_VSTUPNE','0.0',1,'number','Průměrné loňské vstupné','Abychom mohli zobrazit kostku na posuvníku dobrovolného vstupného','2023-06-05 06:53:12','Finance',22,1,2022),(46,'PRUMERNE_LONSKE_VSTUPNE','0',1,'number','Průměrné loňské vstupné','Abychom mohli zobrazit kostku na posuvníku dobrovolného vstupného<hr><i>výchozí hodnota</i>: <i>&gt;&gt;&gt;není&lt;&lt;&lt;</i>','2023-06-05 06:53:12','Finance',22,1,2023),(12,'PRVNI_VLNA_KDY','',1,'datetime','Začátek první vlny aktivit','Kdy se poprvé hromadně změní aktivity Připravené k aktivaci na Aktivované','2023-06-05 06:53:12','Časy',20,0,-1),(29,'REG_GC_DO','',0,'datetime','Ukončení registrací přes web','Do kdy se lze registrovat na Gamecon přes přihlášlu na webu','2023-06-05 06:53:12','Časy',17,0,-1),(11,'REG_GC_OD','',0,'datetime','Začátek registrací účastníků','Od kdy se mohou začít účastníci registrovat na Gamecon','2023-06-05 06:53:12','Časy',7,0,-1),(31,'ROCNIK','2023',1,'integer','Ročník','Který ročník GC je aktivní','2023-06-05 06:53:12','Časy',19,1,-1),(24,'TEXT_PRO_SPAROVANI_ODCHOZI_PLATBY','Vrácení zůstatku účastníka ID',1,'text','Text pro rozpoznání odchozí GC platby','Přesné znění \"Zpráva pro příjemce\", za kterém následuje ID účastníka GC, kterému odesíláme z banky peníze, abychom podle něj spárovali odchozí platbu (stačí nalými písmeny a bez diakritiky)','2023-06-05 06:53:12','Finance',12,0,-1),(34,'TRETI_VLNA_KDY','',0,'datetime','Začátek třetí vlny aktivit','Kdy se potřetí hromadně změní aktivity Připravené k aktivaci na Aktivované','2023-06-05 06:53:12','Časy',22,0,-1),(28,'TRICKA_LZE_OBJEDNAT_A_MENIT_DO_DNE','',0,'date','Ukončení prodeje potištěných triček a tílek na konci dne','Datum, do kdy ještě (včetně) lze v přihlášce měnit trička a tílka, než se zamknou','2023-06-05 06:53:12','Časy',16,0,-1),(25,'UBYTOVANI_LZE_OBJEDNAT_A_MENIT_DO_DNE','2022-07-10',1,'date','Ukončení prodeje bytování na konci dne','Datum, do kdy ještě (včetně) lze v přihlášce měnit ubytování, než se zamkne','2023-06-05 06:53:12','Časy',13,0,-1),(30,'UCASTNIKY_LZE_PRIDAVAT_X_DNI_PO_GC_U_NEUZAVRENE_PREZENCE','30',1,'integer','Do kolika dní po GC lze přidat účastníka','Kolik dní po konci GC lze ještě přidávat účastníky na Neuzavřenou aktivitu','2023-06-05 06:53:12','Časy',18,0,-1),(19,'UCASTNIKY_LZE_PRIDAVAT_X_MINUT_PO_KONCI_AKTIVITY','60',1,'integer','Kolik minut po konci aktivity lze potvrzovat účastníky','Kolik minut může ještě vypravěč zpětně přidávat účastníky a potvrzovat jejich účast od okamžiku jejího skončení. Neplatí pro odebírání účastníků.','2023-06-05 06:53:12','Aktivita',NULL,0,-1),(22,'UPOZORNIT_NA_NEUZAMKNUTOU_AKTIVITU_X_MINUT_PO_KONCI','60',1,'integer','Kdy vypravěče upozorníme že nezavřel','Po jaké době od konce aktivity odešleme vypravěčům mail, že aktivitu neuzavřeli - může to být se zpožděním, automat se pouští jen jednou za hodinu','2023-06-05 06:53:12','Aktivita',NULL,0,-1);
...
-- Dump completed on 2023-06-05  8:57:43
