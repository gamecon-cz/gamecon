...
class PlatbyTest extends AbstractTestDb
{
     ...
     * @test
     */
    public function nastaveniPrahuPodezreleVysokePlatbyExistujeAMaSpravnouHodnotu()
    {
     ...
     * @test
     */
    public function konstantaProPodezreleVysokouPlatbuExistuje()
    {
        self::assertTrue(
     ...
     * @test
     */
    public function nastaveniJeVDatabaziSSpravnymiParametry()
    {
     ...
     * @test
     */
    public function metodaOdesliUpozorneniOPodezreleVysokePlatbeMuzeBytZavolanaBezChyby()
    {
